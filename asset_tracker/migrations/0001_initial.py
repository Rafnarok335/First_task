    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='asset_tracker.assets')),
                ('emp_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='asset_tracker.employee')),
            ],
        ),
    ]
